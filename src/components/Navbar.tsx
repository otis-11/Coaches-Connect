            ...
            {user ? (
              <div ref={dropdownRef} className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-slate-100/80 transition-all"
                >
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-lg border border-slate-200 py-2 z-50">
                    ...
                    <Link href="/notifications" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 transition-colors" onClick={() => setDropdownOpen(false)}>
